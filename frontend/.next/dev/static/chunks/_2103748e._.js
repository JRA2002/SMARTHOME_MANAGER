...
function ChatPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setLoading(true);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].sendChatMessage(input);
...
_s(ChatPage, "PfFMqyC8P480YDb1DjLrGALrxcY=", false, function() {
    return [
